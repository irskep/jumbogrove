  ...
  watch: {
    currentItemId: function currentItemId() {
      this.$nextTick(function () {
        var topEl = lodash_default.a.first(document.querySelectorAll('.m-active-group'));
        var bottomEl = lodash_default.a.last(document.querySelectorAll('.m-active-group'));
        if (!bottomEl) return;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-6f841e1b","hasScoped":true,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/JGUI.vue
...
/* scopeId */
var JGUI___vue_scopeId__ = "data-v-6f841e1b"
/* moduleIdentifier (server only) */
...
/* harmony default export */ var ld40 = ({
  ...
  init: function init(model, ui, md) {
    ...
    try {
      for (var _iterator2 = get_iterator_default()(model.allCharacters), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var c = _step2.value;
